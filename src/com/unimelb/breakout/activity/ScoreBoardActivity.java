...
public class ScoreBoardActivity extends Activity implements ActionBar.TabListener{
	 ...
	 * List of fragments 
	 */
	String fragments[] = {  LocalScoreBoardFragment.class.getName(),
							GlobalScoreBoardFragment.class.getName()};
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			// below).
            return Fragment.instantiate(ScoreBoardActivity.this, fragments[position]);
		}
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.local_scoreboard).toUpperCase(l);
			case 1:
				return getString(R.string.global_scoreboard).toUpperCase(l);
			}
			return null;
